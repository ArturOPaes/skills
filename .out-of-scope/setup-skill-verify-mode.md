# Verify/Check Mode for `setup-tutu-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-tutu-skills`.
...
- #106 — Feature request: verify/check mode for setup-tutu-skills
