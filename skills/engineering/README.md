...
- **[pre-flight](./pre-flight/SKILL.md)** — Before building a wave, confirm its documentation, diagrams, and hi-fi layout are current and cover it, walk them with a human to review and adjust, then greenlight `/implement`. The pre-build twin of `/manual-qa`.
