...
**Cap concurrency at 5.** Never run more than **5 in parallel** — at most 5 browser sessions in phase 1, at most 5 fix workers in phase 2. Queue the rest and start the next only as a slot frees up. Wide, but bounded: past 5 the sessions contend for the machine and the coordinator loses track more than it gains speed.
