...
The acceptance criterion is the test. You don't invent behaviours to cover; you take the ones the ticket or user story already promised and make them executable, linked back by the ticket ID. The criterion is the spec, the e2e is its runnable form.
