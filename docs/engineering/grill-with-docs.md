...
```bash
npx skills add ArturOPaes/skills --skill=grill-with-docs
```
...
[Source](https://github.com/ArturOPaes/skills/tree/main/skills/engineering/grill-with-docs)
...
Reach for it at the very start of a change, when the plan is still fuzzy and the domain language isn't settled, and you want to stress-test both before any code exists. If you only want the interview and don't need the artifacts, use [grilling](https://github.com/ArturOPaes/skills/tree/main/skills/productivity/grilling); if the plan is already clear and you just need to pin down or record terminology, use [domain-modeling](https://github.com/ArturOPaes/skills/tree/main/skills/engineering/domain-modeling). And it **sizes the effort as it opens**: if the change is too big to hold in one session and its route is still foggy — a greenfield project, a huge feature build — it stops and points you at [wayfinder](https://github.com/ArturOPaes/skills/tree/main/skills/engineering/wayfinder), which charts the effort as a map of decisions, then hands back to this main flow once the way is clear. (It recommends the switch rather than invoking wayfinder — both are user-invoked — so entering the map stays your deliberate call.)
...
It comes first, before anything is written down as a spec: it produces the shared understanding and settled vocabulary that [to-spec](https://github.com/ArturOPaes/skills/tree/main/skills/engineering/to-spec) then synthesises into a spec without re-interviewing you. Its close neighbours are [grilling](https://github.com/ArturOPaes/skills/tree/main/skills/productivity/grilling), the same interview without the docs, and [domain-modeling](https://github.com/ArturOPaes/skills/tree/main/skills/engineering/domain-modeling), the glossary-and-ADR discipline it drives. When you're unsure which skill or flow fits, [ask-tutu](https://github.com/ArturOPaes/skills/tree/main/skills/engineering/ask-tutu) routes you.
